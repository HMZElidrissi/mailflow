...
public interface EmailService {
  ...
  Flux<EmailResponse> getEmailsByCampaign(Long campaignId);

  Flux<EmailResponse> getEmailsByContact(Long contactId);

  Mono<EmailStats> getEmailStatsByCampaign(Long campaignId);
